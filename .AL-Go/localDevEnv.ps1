...
$webClient.DownloadFile('https://raw.githubusercontent.com/ctmcomputer/AL-Go-Actions/main/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/ctmcomputer/AL-Go-Actions/main/AL-Go-Helper.ps1', $ALGoHelperPath)
